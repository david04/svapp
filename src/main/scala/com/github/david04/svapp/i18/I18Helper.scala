package com.github.david04.svapp.i18
...
object I18Helper {
  ...
  def fileInLang(f: File, lang: Lang.Lang) = {
    ...
    if (fUserLang.exists()) {
      Logger.getLogger(this.getClass).info("Selecting file '" + f.getName + "' in user language ('" + lang + "')")
      fUserLang
    } else if (fFDefaultLang.exists()) {
      Logger.getLogger(this.getClass).info("Selecting file '" + f.getName + "' in default language ('" + Lang.defaultLang + "')")
      fFDefaultLang
    } else if (fUnknownLang.exists()) {
      Logger.getLogger(this.getClass).warn("Selecting file '" + f.getName + "' in an unknown language. No suitable language found (neither '" + lang + "' nor '" + Lang.defaultLang + "').")
      fUnknownLang
    } else {
